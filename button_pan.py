...
class PannedWindowApp:
    def __init__(self, root):
        ...
        self.prev_button3 = tk.Button(self.frame1, text="TERRAINE DETAILS",font=('Arial',16), width=17, command=self.show_terrain)
        ...
        self.homeFrame = tk.Frame(self.paned_window,bg='#0F2167', width=1400, height=750, relief="raised")
        self.paned_window.add(self.homeFrame)
       # b6=tk.Button(root,text="Optimized route",bg="#363062",font=("Arial",16),borderwidth=0,width=15,fg='white').place(x=760,y=600)

        #ri8 
        home_canvas=tk.Canvas(self.homeFrame,bg="#818FB4",height='515',width='250',borderwidth=0).place(x=1050,y=125)

        dts_lb=tk.Label(self.homeFrame,text="Details",font=("Arial" ,18, "bold"),bg="#818FB4").place(x=1125,y=175)
        long_lb=tk.Label(self.homeFrame,text="Longitude:",font=("Arial" ,18),bg="#818FB4").place(x=1100,y=225)
        longt_lb=tk.Label(self.homeFrame, text="92.11",font=("Arial" ,18),bg="#818FB4").place(x=1100,y=275)
        b6=tk.Button(self.homeFrame,text="Optimized route",bg="#363062",font=("Arial",16),borderwidth=0,width=15,fg='white').place(x=760,y=600)
        lat_lb=tk.Label(self.homeFrame,text="Latitude:",font=("Arial" ,18),bg="#818FB4").place(x=1100,y=325)
        latt_lb=tk.Label(self.homeFrame,text="92.11",font=("Arial" ,18),bg="#818FB4").place(x=1100,y=375)
        spd_lb=tk.Label(self.homeFrame,text="Speed11:",font=("Arial" ,18),bg="#818FB4").place(x=1100,y=425)
        spdt_lb=tk.Label(self.homeFrame,text="21km/h",font=("Arial" ,18),bg="#818FB4").place(x=1100,y=475)
        label1=tk.LabelFrame(self.homeFrame)
        label1.place(x=300,y=70)
       # mapPath = image.jpg
        img = Image.open('Image.jpg')
        newpic1=ImageTk.PhotoImage(img)
        #resized2=newpic1.resize((200,125))
        piclab1=tk.Label(self.homeFrame, image=newpic1,borderwidth=0)
        piclab1.place(x=300,y=100)

        #home
        dep=tk.Label(self.homeFrame,text=("Depature   ---> "),font=("Arial",18,"bold"),bg="#FFFFFF").place(x=475,y=600)
        arr=tk.Label(self.homeFrame,text=(" Arrival "),font=("Arial",18,"bold"),bg="#FFFFFF").place(x=650,y=600)
        dep_lb=tk.Label(self.homeFrame,text="Cochin",font=("Arial" ,18),bg="#FFFFFF").place(x=475,y=650)
        arr_lb=tk.Label(self.homeFrame,text="Cochin",font=("Arial" ,18),bg="#FFFFFF").place(x=655,y=650)
        #img = Image.open(mapPath)
        #newpic1=ImageTk.PhotoImage(img)
        #resized2=newpic1.resize((200,125))
        # piclab1=tk.Label(self.homeframe,image=newpic1,borderwidth=0)
        # piclab1.place(x=300,y=10S0)
...
#         label1=tk.LabelFrame(root).place(x=70,y=150)
    ...
    def show_safety(self):
        ...
        if panes:
            self.paned_window.forget(panes[-1])
        self.safetyframe = tk.Frame(self.paned_window,bg='#0F2167', width=1400, height=750, relief="raised")
        self.paned_window.add(self.safetyframe)
        label1=tk.Label(self.safetyframe,text="saftey page",font=("Arial",28),bg="#0F2167",fg="#FFFFFF").place(x=600,y=50)
    def show_arrival(self):
        ...
        label2=tk.Label(self.frame4,text="ETA",font=("Arial",20),bg="#0F2167",fg="#FFFFFF").place(x=800,y=500)
        entry1=tk.Entry(self.frame4,font=('Arial',20),bg="#FFFFFF",borderwidth=3).place(x=1000,y=500)
        label1=tk.LabelFrame(self.frame4).place(x=70,y=150)
    ...
    def show_terrain(self):
     ...
     if panes:
        ...
        self.safetyframe = tk.Frame(self.paned_window,bg='#0F2167', width=1400, height=750, relief="raised")
        self.paned_window.add(self.safetyframe)
        label1=tk.Label(self.safetyframe,text="weather page",font=("Arial",28),bg="#0F2167",fg="#FFFFFF").place(x=600,y=50)
